...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Maui.Essentials.Implementations.ConnectivityImplementation+EssentialsNetworkCallback, Microsoft.Maui.Essentials", ConnectivityImplementation_EssentialsNetworkCallback.class, __md_methods);
	}
	...
	public ConnectivityImplementation_EssentialsNetworkCallback ()
	{
		...
		if (getClass () == ConnectivityImplementation_EssentialsNetworkCallback.class)
			mono.android.TypeManager.Activate ("Microsoft.Maui.Essentials.Implementations.ConnectivityImplementation+EssentialsNetworkCallback, Microsoft.Maui.Essentials", "", this, new java.lang.Object[] {  });
	}
	...
	public ConnectivityImplementation_EssentialsNetworkCallback (int p0)
	{
		super (p0);
		if (getClass () == ConnectivityImplementation_EssentialsNetworkCallback.class)
			mono.android.TypeManager.Activate ("Microsoft.Maui.Essentials.Implementations.ConnectivityImplementation+EssentialsNetworkCallback, Microsoft.Maui.Essentials", "System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0 });
	}
