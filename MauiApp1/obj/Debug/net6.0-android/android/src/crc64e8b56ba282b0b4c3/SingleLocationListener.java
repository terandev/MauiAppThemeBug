...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Maui.Essentials.Implementations.SingleLocationListener, Microsoft.Maui.Essentials", SingleLocationListener.class, __md_methods);
	}
	...
	public SingleLocationListener ()
	{
		...
		if (getClass () == SingleLocationListener.class)
			mono.android.TypeManager.Activate ("Microsoft.Maui.Essentials.Implementations.SingleLocationListener, Microsoft.Maui.Essentials", "", this, new java.lang.Object[] {  });
	}
