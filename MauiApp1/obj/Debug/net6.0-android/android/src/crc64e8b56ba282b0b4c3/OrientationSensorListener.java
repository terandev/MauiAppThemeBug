...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Microsoft.Maui.Essentials.Implementations.OrientationSensorListener, Microsoft.Maui.Essentials", OrientationSensorListener.class, __md_methods);
	}
	...
	public OrientationSensorListener ()
	{
		...
		if (getClass () == OrientationSensorListener.class)
			mono.android.TypeManager.Activate ("Microsoft.Maui.Essentials.Implementations.OrientationSensorListener, Microsoft.Maui.Essentials", "", this, new java.lang.Object[] {  });
	}
